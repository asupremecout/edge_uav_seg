...
3. **不追求过度创新，而培养发现问题和解决问题能力**

4. **符合你当前水平：理论理解较强，但工程闭环经验不足**

5. **8\~10周可以完成，并且最终具备简历项目价值**
...
> 可以面对一个真实视觉任务，完成数据处理、模型设计、训练优化、性能分析、部署。
> 
> 
...
- 能发挥你已有的 Deep Learning Physics 理解；

- 能补足算法工程最大的短板。

后续执行过程中，除非你的方向发生重大变化，否则不建议再改路线。你现在真正需要的是进入 **Implementation → Experiment → Iteration** 循环。
